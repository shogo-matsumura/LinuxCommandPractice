...
pwd
/Users/matsumurashougo/geekationWorkspace/LinuxCommandPractice
matsumurashougo@matsumurashougonoiMac LinuxCommandPractice % 
...
matsumurashougo@matsumurashougonoiMac practice_dir_2 % rm -i practice_file2.txt
remove practice_file2.txt?
yes
